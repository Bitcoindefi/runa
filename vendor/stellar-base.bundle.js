...
var require_stellar_base_min = __commonJS({
  "node_modules/@stellar/stellar-base/dist/stellar-base.min.js"(exports, module2) {
    !(function(e, t) {
      "object" == typeof exports && "object" == typeof module2 ? module2.exports = t() : "function" == typeof define && define.amd ? define("StellarBase", [], t) : "object" == typeof exports ? exports.StellarBase = t() : e.StellarBase = t();
    })(self, () => (() => {
      var e = { 41(e2, t2, r2) {
        "use strict";
        ...
        function A(e3) {
          return e3 >= b && e3 <= w ? e3 - b : e3 >= S && e3 <= E ? e3 - (S - 10) : e3 >= k && e3 <= T ? e3 - (k - 10) : void 0;
        }
        function O(e3) {
        ...
        class ne extends _ {
          ...
          process(e3, t3) {
            ...
            for (let e4 = 0; e4 < 80; e4++) {
              const t4 = V(l2, f2, 14) ^ V(l2, f2, 18) ^ K(l2, f2, 41), v2 = q(l2, f2, 14) ^ q(l2, f2, 18) ^ H(l2, f2, 41), b2 = l2 & p2 ^ ~l2 & h2, w2 = Y(g2, v2, f2 & d2 ^ ~f2 & y2, ee[e4], re[e4]), S2 = Z(w2, m2, t4, b2, Q[e4], te[e4]), E2 = 0 | w2, k2 = V(r3, n2, 28) ^ K(r3, n2, 34) ^ K(r3, n2, 39), T2 = q(r3, n2, 28) ^ H(r3, n2, 34) ^ H(r3, n2, 39), A2 = r3 & o2 ^ r3 & a2 ^ o2 & a2, O2 = n2 & i2 ^ n2 & s2 ^ i2 & s2;
        ...
        function Ne(e3, t3) {
          const r3 = (e3.ORDER - Ae) / xe, n2 = e3.mul(t3, Ee), o2 = e3.pow(n2, r3), i2 = e3.mul(t3, o2), a2 = e3.mul(e3.mul(i2, Ee), o2), s2 = e3.mul(i2, e3.sub(a2, e3.ONE));
        ...
        function Fe(e3) {
          return e3 % Te === ke ? Ue : e3 % xe === Ae ? Ne : e3 % Be === Pe ? (function(e4) {
        ...
        function ft(e3, t3 = {}) {
          ...
          class h2 {
            ...
            add(e4) {
              f2(e4);
              const { a: t4, d: r4 } = i2, { X: n3, Y: o3, Z: a3, T: s3 } = this, { X: c3, Y: l3, Z: p3, T: d3 } = e4, y3 = u2(n3 * c3), m2 = u2(o3 * l3), g2 = u2(s3 * r4 * d3), v2 = u2(a3 * p3), b2 = u2((n3 + o3) * (c3 + l3) - y3 - m2), w2 = v2 - g2, S2 = v2 + g2, E2 = u2(m2 - t4 * y3), k2 = u2(b2 * w2), T2 = u2(S2 * E2), A2 = u2(b2 * E2), O2 = u2(w2 * S2);
              return new h2(k2, T2, O2, A2);
            }
            subtract(e4) {
        ...
        const Ot = (() => He(St.p, { isLE: true }))(), xt = (() => He(St.n, { isLE: true }))(), Pt = (() => ({ ...St, Fp: Ot, hash: oe, adjustScalarBytes: kt, uvRatio: At }))(), Bt = (() => ht(Pt))();
        ...
        var Kr = (function e3(t3) {
          ...
          return O2.clone = e3, O2.ROUND_UP = 0, O2.ROUND_DOWN = 1, O2.ROUND_CEIL = 2, O2.ROUND_FLOOR = 3, O2.ROUND_HALF_UP = 4, O2.ROUND_HALF_DOWN = 5, O2.ROUND_HALF_EVEN = 6, O2.ROUND_HALF_CEIL = 7, O2.ROUND_HALF_FLOOR = 8, O2.EUCLID = 9, O2.config = O2.set = function(e4) {
            ...
            return { DECIMAL_PLACES: h2, ROUNDING_MODE: y2, EXPONENTIAL_AT: [m2, g2], RANGE: [v2, b2], CRYPTO: w2, MODULO_MODE: S2, POW_PRECISION: E2, FORMAT: k2, ALPHABET: T2 };
            ...
            return function(n3, o3, i3, a3, s3) {
              ...
              for (v3 >= 0 && (f3 = E2, E2 = 0, n3 = n3.replace(".", ""), d3 = (g3 = new O2(o3)).pow(n3.length - v3), E2 = f3, g3.c = t4(qr(Fr(d3.c), d3.e, "0"), 10, i3, e4), g3.e = g3.c.length), l3 = f3 = (m3 = t4(n3, o3, i3, s3 ? (u3 = T2, e4) : (u3 = e4, T2))).length; 0 == m3[--f3]; m3.pop()) ;
            ...
            return function(n3, o3, i3, a3, s3) {
              var u3, c3, l3, f3, p3, d3, h3, y3, m3, g3, v3, b3, w3, S3, E3, k3, T3, A3 = n3.s == o3.s ? 1 : -1, x3 = n3.c, P3 = o3.c;
              ...
              if (P3[l3] > (x3[l3] || 0) && c3--, A3 < 0) m3.push(1), f3 = true;
                ...
                for (S3 = x3.length, k3 = P3.length, l3 = 0, A3 += 2, (p3 = xr(s3 / (P3[0] + 1))) > 1 && (P3 = e4(P3, p3, s3), x3 = e4(x3, p3, s3), k3 = P3.length, S3 = x3.length), w3 = k3, v3 = (g3 = x3.slice(0, k3)).length; v3 < k3; g3[v3++] = 0) ;
                T3 = P3.slice(), T3 = [0].concat(T3), E3 = P3[0], P3[1] >= s3 / 2 && E3++;
                do {
                  if (p3 = 0, (u3 = t4(P3, g3, k3, v3)) < 0) {
                    if (b3 = g3[0], k3 != v3 && (b3 = b3 * s3 + (g3[1] || 0)), (p3 = xr(b3 / E3)) > 1) for (p3 >= s3 && (p3 = s3 - 1), h3 = (d3 = e4(P3, p3, s3)).length, v3 = g3.length; 1 == t4(d3, g3, h3, v3); ) p3--, r4(d3, k3 < h3 ? T3 : P3, h3, s3), h3 = d3.length, u3 = 1;
                    else 0 == p3 && (u3 = p3 = 1), h3 = (d3 = P3.slice()).length;
                    if (h3 < v3 && (d3 = [0].concat(d3)), r4(g3, d3, v3, s3), v3 = g3.length, -1 == u3) for (; t4(P3, g3, k3, v3) < 1; ) p3++, r4(g3, k3 < v3 ? T3 : P3, v3, s3), v3 = g3.length;
                  } else 0 === u3 && (p3++, g3 = [0]);
            ...
            return C2(this);
          }, p2._isBigNumber = true, p2[Symbol.toStringTag] = "BigNumber", p2[/* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom")] = p2.valueOf, null != t3 && O2.set(t3), O2;
        })();
        var Hr = Kr.clone();
        Hr.DEBUG = true;
        const zr = Hr;
          ...
          return (function(e4, t3, r3) {
            ...
            switch (t3.switch().value) {
              ...
              case i.ScAddressType.scAddressTypeClaimableBalance().value:
                ...
                return e3.claimableBalance(En.concat([En.from([n2.switch().value]), n2.v0()]));
        ...
        var _n = 1e7, Un = 1, Nn = 2, Ln = 4, Fn = 8, jn = (function() {
          return (function(e3, t3, r3) {
            ...
            var t3;
            if (void 0 !== e3.n && void 0 !== e3.d) t3 = new i.Price(e3);
            else {
              var r3 = (function(e4) {
        ...
        var Hn = "none", zn = "id", Xn = "text", $n = "hash", Gn = "return", Wn = (function() {
          ...
          return (function(e4, t3, r3) {
            ...
            var t3, r3 = new Error("Expects a uint64 as a string. Got ".concat(e4));
            ...
            if (t3.isNegative()) throw r3;
            if (!t3.isInteger()) throw r3;
            if (t3.isGreaterThan("18446744073709551615")) throw r3;
        ...
        var Io = (function() {
          return (function(e3, t3, r3) {
            ...
            var o2 = nr(r3, e3);
            return n2("signedPayload" === r3 ? new i.SignerKeyEd25519SignedPayload({ ed25519: o2.slice(0, 32), payload: o2.slice(36, 36 + o2.readUInt32BE(32)) }) : o2);
        ...
        function Ro(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, _o(n2.key), n2);
          }
        }
        function _o(e3) {
          var t3 = (function(e4, t4) {
        ...
        var Uo = (function() {
          return (function(e3, t3, r3) {
            return t3 && Ro(e3.prototype, t3), r3 && Ro(e3, r3), Object.defineProperty(e3, "prototype", { writable: false }), e3;
          })(function e3(t3) {
            !(function(e4, t4) {
              if (!(e4 instanceof t4)) throw new TypeError("Cannot call a class as a function");
            })(this, e3);
        ...
        function No(e3) {
          return No = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && "function" == typeof Symbol && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          }, No(e3);
        ...
        function Lo(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, Fo(n2.key), n2);
          }
        }
        function Fo(e3) {
          var t3 = (function(e4, t4) {
            if ("object" != No(e4) || !e4) return e4;
            var r3 = e4[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n2 = r3.call(e4, t4 || "default");
          ...
          return "symbol" == No(t3) ? t3 : t3 + "";
        }
        function jo(e3, t3, r3) {
          return t3 = Do(t3), (function(e4, t4) {
            if (t4 && ("object" == No(t4) || "function" == typeof t4)) return t4;
            if (void 0 !== t4) throw new TypeError("Derived constructors may only return object or undefined");
            return (function(e5) {
              if (void 0 === e5) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
              return e5;
            })(e4);
          })(e3, Mo() ? Reflect.construct(t3, r3 || [], Do(e3).constructor) : t3.apply(e3, r3));
        }
        function Mo() {
          try {
            var e3 = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function() {
        ...
        function Do(e3) {
          return Do = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e4) {
            return e4.__proto__ || Object.getPrototypeOf(e4);
          }, Do(e3);
        }
        function Vo(e3, t3) {
          return Vo = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e4, t4) {
            return e4.__proto__ = t4, e4;
          }, Vo(e3, t3);
        }
        var qo = (function(e3) {
          function t3() {
            ...
            return jo(this, t3, [r3]);
          }
          return (function(e4, t4) {
            if ("function" != typeof t4 && null !== t4) throw new TypeError("Super expression must either be null or a function");
            e4.prototype = Object.create(t4 && t4.prototype, { constructor: { value: e4, writable: true, configurable: true } }), Object.defineProperty(e4, "prototype", { writable: false }), t4 && Vo(e4, t4);
          })(t3, e3), (function(e4, t4, r3) {
            return t4 && Lo(e4.prototype, t4), r3 && Lo(e4, r3), Object.defineProperty(e4, "prototype", { writable: false }), e4;
        ...
        function Ho(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, zo(n2.key), n2);
          }
        }
        function zo(e3) {
          var t3 = (function(e4, t4) {
        ...
        function Xo(e3, t3, r3) {
          return t3 = Go(t3), (function(e4, t4) {
            if (t4 && ("object" == Ko(t4) || "function" == typeof t4)) return t4;
            if (void 0 !== t4) throw new TypeError("Derived constructors may only return object or undefined");
            return (function(e5) {
              if (void 0 === e5) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
              return e5;
            })(e4);
          })(e3, $o() ? Reflect.construct(t3, r3 || [], Go(e3).constructor) : t3.apply(e3, r3));
        }
        function $o() {
          try {
            var e3 = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function() {
        ...
        function Go(e3) {
          return Go = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e4) {
            return e4.__proto__ || Object.getPrototypeOf(e4);
          }, Go(e3);
        }
        function Wo(e3, t3) {
          return Wo = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e4, t4) {
            return e4.__proto__ = t4, e4;
          }, Wo(e3, t3);
        }
        ...
        var Yo = (function(e3) {
          function t3() {
            ...
            for (var e4 = arguments.length, r3 = new Array(e4), n2 = 0; n2 < e4; n2++) r3[n2] = arguments[n2];
            return Xo(this, t3, [r3]);
          }
          return (function(e4, t4) {
            if ("function" != typeof t4 && null !== t4) throw new TypeError("Super expression must either be null or a function");
            e4.prototype = Object.create(t4 && t4.prototype, { constructor: { value: e4, writable: true, configurable: true } }), Object.defineProperty(e4, "prototype", { writable: false }), t4 && Wo(e4, t4);
          })(t3, e3), (function(e4, t4, r3) {
            return t4 && Ho(e4.prototype, t4), r3 && Ho(e4, r3), Object.defineProperty(e4, "prototype", { writable: false }), e4;
          })(t3, [{ key: "unsigned", get: function() {
            return true;
          } }, { key: "size", get: function() {
            return 256;
        ...
        function Zo(e3) {
          return Zo = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && "function" == typeof Symbol && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          }, Zo(e3);
        ...
        function Jo(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, Qo(n2.key), n2);
          }
        }
        function Qo(e3) {
          var t3 = (function(e4, t4) {
            if ("object" != Zo(e4) || !e4) return e4;
            var r3 = e4[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n2 = r3.call(e4, t4 || "default");
          ...
          return "symbol" == Zo(t3) ? t3 : t3 + "";
        }
        function ei(e3, t3, r3) {
          return t3 = ri(t3), (function(e4, t4) {
            if (t4 && ("object" == Zo(t4) || "function" == typeof t4)) return t4;
            if (void 0 !== t4) throw new TypeError("Derived constructors may only return object or undefined");
            return (function(e5) {
              if (void 0 === e5) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
              return e5;
            })(e4);
          })(e3, ti() ? Reflect.construct(t3, r3 || [], ri(e3).constructor) : t3.apply(e3, r3));
        }
        function ti() {
          try {
            var e3 = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function() {
        ...
        function ri(e3) {
          return ri = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e4) {
            return e4.__proto__ || Object.getPrototypeOf(e4);
          }, ri(e3);
        }
        function ni(e3, t3) {
          return ni = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e4, t4) {
            return e4.__proto__ = t4, e4;
          }, ni(e3, t3);
        }
        ...
        var oi = (function(e3) {
          function t3() {
            ...
            for (var e4 = arguments.length, r3 = new Array(e4), n2 = 0; n2 < e4; n2++) r3[n2] = arguments[n2];
            return ei(this, t3, [r3]);
          }
          return (function(e4, t4) {
            if ("function" != typeof t4 && null !== t4) throw new TypeError("Super expression must either be null or a function");
            e4.prototype = Object.create(t4 && t4.prototype, { constructor: { value: e4, writable: true, configurable: true } }), Object.defineProperty(e4, "prototype", { writable: false }), t4 && ni(e4, t4);
          })(t3, e3), (function(e4, t4, r3) {
            return t4 && Jo(e4.prototype, t4), r3 && Jo(e4, r3), Object.defineProperty(e4, "prototype", { writable: false }), e4;
          })(t3, [{ key: "unsigned", get: function() {
            return false;
          } }, { key: "size", get: function() {
            return 128;
        ...
        function ii(e3) {
          return ii = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && "function" == typeof Symbol && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          }, ii(e3);
        ...
        function ai(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, si(n2.key), n2);
          }
        }
        function si(e3) {
          var t3 = (function(e4, t4) {
            if ("object" != ii(e4) || !e4) return e4;
            var r3 = e4[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n2 = r3.call(e4, t4 || "default");
              if ("object" != ii(n2)) return n2;
              throw new TypeError("@@toPrimitive must return a primitive value.");
            }
            return ("string" === t4 ? String : Number)(e4);
          })(e3, "string");
          return "symbol" == ii(t3) ? t3 : t3 + "";
        }
        function ui(e3, t3, r3) {
          return t3 = li(t3), (function(e4, t4) {
            if (t4 && ("object" == ii(t4) || "function" == typeof t4)) return t4;
            if (void 0 !== t4) throw new TypeError("Derived constructors may only return object or undefined");
            return (function(e5) {
              if (void 0 === e5) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
              return e5;
            })(e4);
          })(e3, ci() ? Reflect.construct(t3, r3 || [], li(e3).constructor) : t3.apply(e3, r3));
        }
        function ci() {
          try {
            var e3 = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function() {
        ...
        function li(e3) {
          return li = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e4) {
            return e4.__proto__ || Object.getPrototypeOf(e4);
          }, li(e3);
        }
        function fi(e3, t3) {
          return fi = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e4, t4) {
            return e4.__proto__ = t4, e4;
          }, fi(e3, t3);
        }
        ...
        var pi = (function(e3) {
          function t3() {
            ...
            for (var e4 = arguments.length, r3 = new Array(e4), n2 = 0; n2 < e4; n2++) r3[n2] = arguments[n2];
            return ui(this, t3, [r3]);
          }
          return (function(e4, t4) {
            if ("function" != typeof t4 && null !== t4) throw new TypeError("Super expression must either be null or a function");
            e4.prototype = Object.create(t4 && t4.prototype, { constructor: { value: e4, writable: true, configurable: true } }), Object.defineProperty(e4, "prototype", { writable: false }), t4 && fi(e4, t4);
          })(t3, e3), (function(e4, t4, r3) {
        ...
        function di(e3) {
          return di = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && "function" == typeof Symbol && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          }, di(e3);
        ...
        function yi(e3, t3, r3) {
          return (t3 = mi(t3)) in e3 ? Object.defineProperty(e3, t3, { value: r3, enumerable: true, configurable: true, writable: true }) : e3[t3] = r3, e3;
        }
        function mi(e3) {
          var t3 = (function(e4, t4) {
            if ("object" != di(e4) || !e4) return e4;
            var r3 = e4[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n2 = r3.call(e4, t4 || "default");
              if ("object" != di(n2)) return n2;
              throw new TypeError("@@toPrimitive must return a primitive value.");
            }
            return ("string" === t4 ? String : Number)(e4);
          })(e3, "string");
          return "symbol" == di(t3) ? t3 : t3 + "";
        }
        pi.defineIntBoundaries();
        var gi = (function() {
          return (function(e3, t3, r3) {
            return t3 && hi(e3.prototype, t3), r3 && hi(e3, r3), Object.defineProperty(e3, "prototype", { writable: false }), e3;
          })(function e3(t3, r3) {
            switch ((function(e4, t4) {
              if (!(e4 instanceof t4)) throw new TypeError("Cannot call a class as a function");
            })(this, e3), yi(this, "int", void 0), yi(this, "type", void 0), r3 instanceof Array || (r3 = [r3]), r3 = r3.map(function(e4) {
        ...
        function vi(e3) {
          return vi = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && "function" == typeof Symbol && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          }, vi(e3);
        ...
        function bi(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, wi(n2.key), n2);
          }
        }
        function wi(e3) {
          var t3 = (function(e4, t4) {
            if ("object" != vi(e4) || !e4) return e4;
            var r3 = e4[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n2 = r3.call(e4, t4 || "default");
              if ("object" != vi(n2)) return n2;
              throw new TypeError("@@toPrimitive must return a primitive value.");
            }
            return ("string" === t4 ? String : Number)(e4);
          })(e3, "string");
          return "symbol" == vi(t3) ? t3 : t3 + "";
        }
        function Si(e3, t3, r3) {
          return t3 = ki(t3), (function(e4, t4) {
            if (t4 && ("object" == vi(t4) || "function" == typeof t4)) return t4;
            if (void 0 !== t4) throw new TypeError("Derived constructors may only return object or undefined");
            return (function(e5) {
              if (void 0 === e5) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
              return e5;
            })(e4);
          })(e3, Ei() ? Reflect.construct(t3, r3 || [], ki(e3).constructor) : t3.apply(e3, r3));
        }
        function Ei() {
          try {
            var e3 = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function() {
        ...
        function Ti(e3, t3) {
          return Ti = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e4, t4) {
            return e4.__proto__ = t4, e4;
          }, Ti(e3, t3);
        }
        var Ai = (function(e3) {
          function t3(e4, r3) {
            ...
            var o2 = BigInt(e4), i2 = o2 < 0n, a2 = null !== (n2 = null == r3 ? void 0 : r3.type) && void 0 !== n2 ? n2 : "";
            if (a2.startsWith("u") && i2) throw TypeError("specified type ".concat(r3.type, " yet negative (").concat(e4, ")"));
            if ("" === a2) {
              a2 = i2 ? "i" : "u";
              var s2 = (function(e5) {
              ...
              switch (s2) {
                ...
                case 256:
                  ...
                  break;
                default:
                  throw RangeError("expected 64/128/256 bits for input (".concat(e4, "), got ").concat(s2));
              }
            }
            return Si(this, t3, [a2, o2]);
          }
          return (function(e4, t4) {
            if ("function" != typeof t4 && null !== t4) throw new TypeError("Super expression must either be null or a function");
            e4.prototype = Object.create(t4 && t4.prototype, { constructor: { value: e4, writable: true, configurable: true } }), Object.defineProperty(e4, "prototype", { writable: false }), t4 && Ti(e4, t4);
          })(t3, e3), (function(e4, t4, r3) {
            return t4 && bi(e4.prototype, t4), r3 && bi(e4, r3), Object.defineProperty(e4, "prototype", { writable: false }), e4;
          })(t3);
        })(gi);
        function Oi(e3) {
          var t3 = gi.getType(e3.switch().name);
          switch (e3.switch().name) {
            ...
            case "scvTimepoint":
            case "scvDuration":
              return new gi(t3, e3.value()).toBigInt();
            case "scvU128":
            case "scvI128":
              return new gi(t3, [e3.value().lo(), e3.value().hi()]).toBigInt();
            case "scvU256":
            case "scvI256":
              return new gi(t3, [e3.value().loLo(), e3.value().loHi(), e3.value().hiLo(), e3.value().hiHi()]).toBigInt();
            default:
        ...
        function Pi(e3, t3) {
          return (function(e4) {
            ...
            if (e4) {
              if ("string" == typeof e4) return Bi(e4, t4);
              var r3 = {}.toString.call(e4).slice(8, -1);
              return "Object" === r3 && e4.constructor && (r3 = e4.constructor.name), "Map" === r3 || "Set" === r3 ? Array.from(e4) : "Arguments" === r3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r3) ? Bi(e4, t4) : void 0;
            }
          })(e3, t3) || (function() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
          })();
        ...
        function Ci(e3, t3, r3) {
          return (t3 = (function(e4) {
            var t4 = (function(e5, t5) {
              if ("object" != Ri(e5) || !e5) return e5;
        ...
        function _i(e3) {
          ...
          switch (Ri(e3)) {
            case "object":
              ...
              if (e3 instanceof lr) return _i(e3.publicKey(), { type: "address" });
              if (e3 instanceof Uo) return e3.address().toScVal();
              ...
              if (Array.isArray(e3)) return i.ScVal.scvVec(e3.map(function(e4, r4) {
                return Array.isArray(t3.type) ? _i(e4, (function(e5) {
                  for (var t4 = 1; t4 < arguments.length; t4++) {
                    var r5 = null != arguments[t4] ? arguments[t4] : {};
                    t4 % 2 ? Ii(Object(r5), true).forEach(function(t5) {
                      Ci(e5, t5, r5[t5]);
                    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e5, Object.getOwnPropertyDescriptors(r5)) : Ii(Object(r5)).forEach(function(t5) {
                      Object.defineProperty(e5, t5, Object.getOwnPropertyDescriptor(r5, t5));
                    });
                  }
                  return e5;
                })({}, t3.type.length > r4 && { type: t3.type[r4] })) : _i(e4, t3);
              }));
              ...
              return i.ScVal.scvMap(Object.entries(e3).sort(function(e4, t4) {
                var r4 = Pi(e4, 1)[0], n3 = Pi(t4, 1)[0];
                return r4.localeCompare(n3);
              }).map(function(e4) {
                var r4, n3, o3 = Pi(e4, 2), a3 = o3[0], s3 = o3[1], u3 = Pi(null !== (r4 = (null !== (n3 = null == t3 ? void 0 : t3.type) && void 0 !== n3 ? n3 : {})[a3]) && void 0 !== r4 ? r4 : [null, null], 2), c3 = u3[0], l2 = u3[1], f2 = c3 ? { type: c3 } : {}, p2 = l2 ? { type: l2 } : {};
                return new i.ScMapEntry({ key: _i(a3, f2), val: _i(s3, p2) });
              }));
            case "number":
            case "bigint":
              ...
              return new Ai(e3, { type: null == t3 ? void 0 : t3.type }).toScVal();
            case "string":
              ...
              switch (c2) {
                ...
                default:
                  if (gi.isType(c2)) return new gi(c2, e3).toScVal();
            ...
            case "function":
              return _i(e3());
            default:
              throw new TypeError("failed to convert typeof ".concat(Ri(e3), " (").concat(e3, ")"));
          }
        }
        function Ui(e3) {
          var t3, r3;
          switch (e3.switch().value) {
            ...
            case i.ScValType.scvVec().value:
              return (null !== (t3 = e3.vec()) && void 0 !== t3 ? t3 : []).map(Ui);
        ...
        function Ni(e3) {
          return Ni = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && "function" == typeof Symbol && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          }, Ni(e3);
        ...
        function Li(e3) {
          return (function(e4) {
            if (Array.isArray(e4)) return Fi(e4);
          })(e3) || (function(e4) {
            if ("undefined" != typeof Symbol && null != e4[Symbol.iterator] || null != e4["@@iterator"]) return Array.from(e4);
          })(e3) || (function(e4, t3) {
            if (e4) {
              if ("string" == typeof e4) return Fi(e4, t3);
              var r3 = {}.toString.call(e4).slice(8, -1);
              return "Object" === r3 && e4.constructor && (r3 = e4.constructor.name), "Map" === r3 || "Set" === r3 ? Array.from(e4) : "Arguments" === r3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r3) ? Fi(e4, t3) : void 0;
            }
          })(e3) || (function() {
        ...
        function Mi(e3) {
          for (var t3 = 1; t3 < arguments.length; t3++) {
            var r3 = null != arguments[t3] ? arguments[t3] : {};
            t3 % 2 ? ji(Object(r3), true).forEach(function(t4) {
              Di(e3, t4, r3[t4]);
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e3, Object.getOwnPropertyDescriptors(r3)) : ji(Object(r3)).forEach(function(t4) {
              Object.defineProperty(e3, t4, Object.getOwnPropertyDescriptor(r3, t4));
            });
          }
          return e3;
        ...
        function Di(e3, t3, r3) {
          return (t3 = qi(t3)) in e3 ? Object.defineProperty(e3, t3, { value: r3, enumerable: true, configurable: true, writable: true }) : e3[t3] = r3, e3;
        }
        function Vi(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, qi(n2.key), n2);
          }
        }
        function qi(e3) {
          var t3 = (function(e4, t4) {
            if ("object" != Ni(e4) || !e4) return e4;
            var r3 = e4[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n2 = r3.call(e4, t4 || "default");
              if ("object" != Ni(n2)) return n2;
              throw new TypeError("@@toPrimitive must return a primitive value.");
            }
            return ("string" === t4 ? String : Number)(e4);
          })(e3, "string");
          return "symbol" == Ni(t3) ? t3 : t3 + "";
        }
        i.scvSortedMap = function(e3) {
          var t3 = Array.from(e3).sort(function(e4, t4) {
            var r3 = Ui(e4.key()), n2 = Ui(t4.key());
            switch (Ri(r3)) {
              case "number":
              case "bigint":
                return r3 < n2 ? -1 : 1;
        ...
        var Ki = "100", Hi = 0, zi = (function() {
          ...
          return (function(e4, t3, r3) {
            ...
            return this.extraSigners = Li(e4), this;
          ...
          } }, { key: "addSacTransferOperation", value: function(e4, t3, r3, o2) {
            if (BigInt(r3) <= 0n) throw new Error("Amount must be a positive integer");
            if (BigInt(r3) > n.Hyper.MAX_VALUE) throw new Error("Amount exceeds maximum value for i64");
            if (o2) {
              var a2 = o2.instructions, s2 = o2.readBytes, u2 = o2.writeBytes, c2 = o2.resourceFee, l2 = 4294967295;
              if (a2 <= 0 || a2 > l2) throw new Error("instructions must be greater than 0 and at most ".concat(l2));
              if (s2 <= 0 || s2 > l2) throw new Error("readBytes must be greater than 0 and at most ".concat(l2));
              if (u2 <= 0 || u2 > l2) throw new Error("writeBytes must be greater than 0 and at most ".concat(l2));
              if (c2 <= 0n || c2 > n.Hyper.MAX_VALUE) throw new Error("resourceFee must be greater than 0 and at most i64 max");
            }
            var f2 = tr.isValidContract(e4);
            if (!f2 && !tr.isValidEd25519PublicKey(e4) && !tr.isValidMed25519PublicKey(e4)) throw new Error("Invalid destination address. Must be a valid Stellar address or contract ID.");
            if (e4 === this.source.accountId()) throw new Error("Destination cannot be the same as the source account.");
            var p2 = t3.contractId(this.networkPassphrase), d2 = "transfer", h2 = this.source.accountId(), y2 = [_i(h2, { type: "address" }), _i(e4, { type: "address" }), _i(r3, { type: "i128" })], m2 = t3.isNative(), g2 = new i.SorobanAuthorizationEntry({ credentials: i.SorobanCredentials.sorobanCredentialsSourceAccount(), rootInvocation: new i.SorobanAuthorizedInvocation({ function: i.SorobanAuthorizedFunction.sorobanAuthorizedFunctionTypeContractFn(new i.InvokeContractArgs({ contractAddress: On.fromString(p2).toScAddress(), functionName: d2, args: y2 })), subInvocations: [] }) }), v2 = new i.LedgerFootprint({ readOnly: [i.LedgerKey.contractData(new i.LedgerKeyContractData({ contract: On.fromString(p2).toScAddress(), key: i.ScVal.scvLedgerKeyContractInstance(), durability: i.ContractDataDurability.persistent() }))], readWrite: [] });
            f2 ? (v2.readWrite().push(i.LedgerKey.contractData(new i.LedgerKeyContractData({ contract: On.fromString(p2).toScAddress(), key: i.ScVal.scvVec([_i("Balance", { type: "symbol" }), _i(e4, { type: "address" })]), durability: i.ContractDataDurability.persistent() }))), m2 || v2.readOnly().push(i.LedgerKey.account(new i.LedgerKeyAccount({ accountId: lr.fromPublicKey(t3.getIssuer()).xdrPublicKey() })))) : m2 ? v2.readWrite().push(i.LedgerKey.account(new i.LedgerKeyAccount({ accountId: lr.fromPublicKey(e4).xdrPublicKey() }))) : t3.getIssuer() !== e4 && v2.readWrite().push(i.LedgerKey.trustline(new i.LedgerKeyTrustLine({ accountId: lr.fromPublicKey(e4).xdrPublicKey(), asset: t3.toTrustLineXDRObject() }))), t3.isNative() ? v2.readWrite().push(i.LedgerKey.account(new i.LedgerKeyAccount({ accountId: lr.fromPublicKey(h2).xdrPublicKey() }))) : t3.getIssuer() !== h2 && v2.readWrite().push(i.LedgerKey.trustline(new i.LedgerKeyTrustLine({ accountId: lr.fromPublicKey(h2).xdrPublicKey(), asset: t3.toTrustLineXDRObject() })));
            var b2 = { instructions: 4e5, readBytes: 1e3, writeBytes: 1e3, resourceFee: BigInt(5e6) }, w2 = new i.SorobanTransactionData({ resources: new i.SorobanResources({ footprint: v2, instructions: o2 ? o2.instructions : b2.instructions, diskReadBytes: o2 ? o2.readBytes : b2.readBytes, writeBytes: o2 ? o2.writeBytes : b2.writeBytes }), ext: new i.SorobanTransactionDataExt(0), resourceFee: new i.Int64(o2 ? o2.resourceFee : b2.resourceFee) }), S2 = jn.invokeContractFunction({ contract: p2, function: d2, args: y2, auth: [g2] });
            return this.setSorobanData(w2), this.addOperation(S2);
          } }, { key: "build", value: function() {
            ...
            t3.sourceAccount = pn(this.source.accountId()), this.sorobanData ? (t3.ext = new i.TransactionExt(1, this.sorobanData), t3.fee = new zr(t3.fee).plus(this.sorobanData.resourceFee()).toNumber()) : t3.ext = new i.TransactionExt(0, i.Void);
            ...
            var r3, n2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            if (!(t3 instanceof oo)) throw new TypeError("expected a 'Transaction', got: ".concat(t3));
            var o2, i2 = (BigInt(t3.sequence) - 1n).toString();
            if (tr.isValidMed25519PublicKey(t3.source)) o2 = Eo.fromAddress(t3.source, i2);
            else {
              if (!tr.isValidEd25519PublicKey(t3.source)) throw new TypeError("unsupported tx source account: ".concat(t3.source));
              o2 = new vo(t3.source, i2);
            }
            var a2 = new e3(o2, Mi({ fee: (Math.floor(parseInt(t3.fee, 10) / t3.operations.length) || Ki).toString(), memo: t3.memo, networkPassphrase: t3.networkPassphrase, timebounds: t3.timeBounds, ledgerbounds: t3.ledgerBounds, minAccountSequence: t3.minAccountSequence, minAccountSequenceAge: t3.minAccountSequenceAge, minAccountSequenceLedgerGap: t3.minAccountSequenceLedgerGap, extraSigners: null === (r3 = t3.extraSigners) || void 0 === r3 ? void 0 : r3.map(Io.encodeSignerKey) }, n2));
            return t3._tx.operations().forEach(function(e4) {
              return a2.addOperation(e4);
            }), a2;
          } }, { key: "buildFeeBumpTransaction", value: function(e4, t3, r3, n2) {
            var o2 = r3.operations.length, a2 = new zr(Ki), s2 = new zr(0), u2 = r3.toEnvelope();
            if (u2.switch().value === i.EnvelopeType.envelopeTypeTx().value) {
              var c2, l2 = u2.v1().tx().ext().value();
              s2 = new zr(null !== (c2 = null == l2 ? void 0 : l2.resourceFee()) && void 0 !== c2 ? c2 : 0);
            }
            var f2 = new zr(r3.fee).minus(s2).div(o2), p2 = new zr(t3);
            if (p2.lt(f2)) throw new Error("Invalid baseFee, it should be at least ".concat(f2, " stroops."));
            ...
            var g2 = new i.FeeBumpTransaction({ feeSource: d2, fee: i.Int64.fromString(p2.times(o2 + 1).plus(s2).toString()), innerTx: i.FeeBumpTransactionInnerTx.envelopeTypeTx(h2.v1()), ext: new i.FeeBumpTransactionExt(0) }), v2 = new i.FeeBumpTransactionEnvelope({ tx: g2, signatures: [] }), b2 = new i.TransactionEnvelope.envelopeTypeTxFeeBump(v2);
            return new ho(b2, n2);
        ...
        var $i = { PUBLIC: "Public Global Stellar Network ; September 2015", TESTNET: "Test SDF Network ; September 2015", FUTURENET: "Test SDF Future Network ; October 2022", SANDBOX: "Local Sandbox Stellar Network ; September 2022", STANDALONE: "Standalone Network ; February 2017" };
        function Gi(e3) {
          return Gi = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && "function" == typeof Symbol && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          }, Gi(e3);
        ...
        function Wi(e3) {
          return (function(e4) {
            ...
            if (e4) {
              if ("string" == typeof e4) return Yi(e4, t3);
              var r3 = {}.toString.call(e4).slice(8, -1);
              return "Object" === r3 && e4.constructor && (r3 = e4.constructor.name), "Map" === r3 || "Set" === r3 ? Array.from(e4) : "Arguments" === r3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r3) ? Yi(e4, t3) : void 0;
            }
          })(e3) || (function() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
          })();
        ...
        function Zi(e3, t3) {
          for (var r3 = 0; r3 < t3.length; r3++) {
            var n2 = t3[r3];
            n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e3, Ji(n2.key), n2);
          }
        }
        function Ji(e3) {
          var t3 = (function(e4, t4) {
            if ("object" != Gi(e4) || !e4) return e4;
            var r3 = e4[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n2 = r3.call(e4, t4 || "default");
              if ("object" != Gi(n2)) return n2;
              throw new TypeError("@@toPrimitive must return a primitive value.");
            }
            return ("string" === t4 ? String : Number)(e4);
          })(e3, "string");
          return "symbol" == Gi(t3) ? t3 : t3 + "";
        }
        var Qi = (function() {
          return (function(e3, t3, r3) {
            return t3 && Zi(e3.prototype, t3), r3 && Zi(e3, r3), Object.defineProperty(e3, "prototype", { writable: false }), e3;
          })(function e3() {
            !(function(e4, t3) {
              if (!(e4 instanceof t3)) throw new TypeError("Cannot call a class as a function");
            })(this, e3);
            ...
            var r3, n2 = Wi(e3.split(".").slice()), o2 = n2[0], i2 = n2[1];
            if (Yi(n2).slice(2).length) throw new Error("Invalid decimal value: ".concat(e3));
            if ((null == i2 ? void 0 : i2.length) > t3) throw new Error('Too many decimal places in "'.concat(e3, '": expected at most ').concat(t3, ", got ").concat(i2.length));
        ...
        function fa() {
          ...
          return e3 = sa().m(function e4(t3, r3, n2) {
            ...
            return sa().w(function(e5) {
              for (; ; ) switch (e5.n) {
                case 0:
                  if (o2 = m2.length > 3 && void 0 !== m2[3] ? m2[3] : $i.FUTURENET, t3.credentials().switch().value === i.SorobanCredentialsType.sorobanCredentialsAddress().value) {
                    e5.n = 1;
                    break;
                  }
                  return e5.a(2, t3);
                ...
                case 5:
                  return y2 = _i({ public_key: tr.decodeEd25519PublicKey(d2), signature: p2 }, { type: { public_key: ["symbol", null], signature: ["symbol", null] } }), s2.signature(i.ScVal.scvVec([y2])), e5.a(2, a2);
              }
            }, e4);
          }), fa = function() {
        ...
        function pa(e3, t3, r3) {
          var n2, o2, a2, s2, u2 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "", c2 = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : $i.FUTURENET, l2 = lr.random().rawPublicKey(), f2 = new i.Int64((n2 = l2.subarray(0, 8), o2 = n2[0] << 24 | n2[1] << 16 | n2[2] << 8 | n2[3], a2 = n2[4] << 24 | n2[5] << 16 | n2[6] << 8 | n2[7], s2 = BigInt(o2 >>> 0) * BigInt(Math.pow(2, 32)) + BigInt(a2 >>> 0), BigInt.asIntN(64, s2))), p2 = u2 || e3.publicKey();
          if (!p2) throw new Error("authorizeInvocation requires publicKey parameter");
          return la(new i.SorobanAuthorizationEntry({ rootInvocation: r3, credentials: i.SorobanCredentials.sorobanCredentialsAddress(new i.SorobanAddressCredentials({ address: new On(p2).toScAddress(), nonce: f2, signatureExpirationLedger: 0, signature: i.ScVal.scvVec([]) })) }), e3, t3, c2);
        }
        function da(e3) {
        ...
        function d(e3, r3, n2) {
          ...
          return E(r3) && (l2 = " " + RegExp.prototype.toString.call(r3)), T(r3) && (l2 = " " + Date.prototype.toUTCString.call(r3)), A(r3) && (l2 = " " + h(r3)), 0 !== a2.length || f2 && 0 != r3.length ? n2 < 0 ? E(r3) ? e3.stylize(RegExp.prototype.toString.call(r3), "regexp") : e3.stylize("[Object]", "special") : (e3.seen.push(r3), c2 = f2 ? (function(e4, t3, r4, n3, o3) {
        ...
        }, t2.isUndefined = S, t2.isRegExp = E, t2.types.isRegExp = E, t2.isObject = k, t2.isDate = T, t2.types.isDate = T, t2.isError = A, t2.types.isNativeError = A, t2.isFunction = O, t2.isPrimitive = function(e3) {
        ...
        var C = "undefined" != typeof Symbol ? /* @__PURE__ */ Symbol("util.promisify.custom") : void 0;
        function R(e3, t3) {
          if (!e3) {
        ...
        e2.exports = function() {
          ...
          var e3 = {}, t2 = /* @__PURE__ */ Symbol("test"), r2 = Object(t2);
        ...
        n(u, o), u.prototype.init = function() {
          ...
          for (var t3 = this._w, r3 = 0 | this._ah, n2 = 0 | this._bh, o2 = 0 | this._ch, i2 = 0 | this._dh, s2 = 0 | this._eh, u2 = 0 | this._fh, v = 0 | this._gh, b = 0 | this._hh, w = 0 | this._al, S = 0 | this._bl, E = 0 | this._cl, k = 0 | this._dl, T = 0 | this._el, A = 0 | this._fl, O = 0 | this._gl, x = 0 | this._hl, P = 0; P < 32; P += 2) t3[P] = e3.readInt32BE(4 * P), t3[P + 1] = e3.readInt32BE(4 * P + 4);
          for (; P < 160; P += 2) {
          ...
          for (var V = 0; V < 160; V += 2) {
            D = t3[V], M = t3[V + 1];
            var q = l(r3, n2, o2), K = l(w, S, E), H = f(r3, w), z = f(w, r3), X = p(s2, T), $ = p(T, s2), G = a[V], W = a[V + 1], Y = c(s2, u2, v), Z = c(T, A, O), J = x + $ | 0, Q = b + X + g(J, x) | 0;
            Q = (Q = (Q = Q + Y + g(J = J + Z | 0, Z) | 0) + G + g(J = J + W | 0, W) | 0) + D + g(J = J + M | 0, M) | 0;
            var ee = z + K | 0, te = H + q + g(ee, z) | 0;
            b = v, x = O, v = u2, O = A, u2 = s2, A = T, s2 = i2 + Q + g(T = k + J | 0, k) | 0, i2 = o2, k = E, o2 = n2, E = S, n2 = r3, S = w, r3 = Q + te + g(w = J + ee | 0, J) | 0;
          }
        ...
        n = () => (() => {
          var e3 = { 348(e4, t4, r4) {
            ...
            t4.byteLength = function(e5) {
              ...
              var t5, r5, i2 = s(e5), a2 = i2[0], u2 = i2[1], c2 = new o2((function(e6, t6, r6) {
                return 3 * (t6 + r6) / 4 - r6;
              })(0, a2, u2)), l = 0, f = u2 > 0 ? a2 - 4 : a2;
              for (r5 = 0; r5 < f; r5 += 4) t5 = n2[e5.charCodeAt(r5)] << 18 | n2[e5.charCodeAt(r5 + 1)] << 12 | n2[e5.charCodeAt(r5 + 2)] << 6 | n2[e5.charCodeAt(r5 + 3)], c2[l++] = t5 >> 16 & 255, c2[l++] = t5 >> 8 & 255, c2[l++] = 255 & t5;
              return 2 === u2 && (t5 = n2[e5.charCodeAt(r5)] << 2 | n2[e5.charCodeAt(r5 + 1)] >> 4, c2[l++] = 255 & t5), 1 === u2 && (t5 = n2[e5.charCodeAt(r5)] << 10 | n2[e5.charCodeAt(r5 + 1)] << 4 | n2[e5.charCodeAt(r5 + 2)] >> 2, c2[l++] = t5 >> 8 & 255, c2[l++] = 255 & t5), c2;
            }, t4.fromByteArray = function(e5) {
              for (var t5, n3 = e5.length, o3 = n3 % 3, i2 = [], a2 = 16383, s2 = 0, u2 = n3 - o3; s2 < u2; s2 += a2) i2.push(c(e5, s2, s2 + a2 > u2 ? u2 : s2 + a2));
            ...
            function u(e5) {
              return r4[e5 >> 18 & 63] + r4[e5 >> 12 & 63] + r4[e5 >> 6 & 63] + r4[63 & e5];
            }
            function c(e5, t5, r5) {
              for (var n3, o3 = [], i2 = t5; i2 < r5; i2 += 3) n3 = (e5[i2] << 16 & 16711680) + (e5[i2 + 1] << 8 & 65280) + (255 & e5[i2 + 2]), o3.push(u(n3));
              return o3.join("");
            }
            n2["-".charCodeAt(0)] = 62, n2["_".charCodeAt(0)] = 63;
          }, 686(e4, t4, r4) {
            "use strict";
            const n2 = r4(350), i = r4(947), a = "function" == typeof Symbol && "function" == typeof Symbol.for ? /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom") : null;
            t4.hp = c, t4.IS = 50;
            const s = 2147483647;
            function u(e5) {
            ...
            "use strict";
            r4.r(t4), r4.d(t4, { Array: () => q, Bool: () => N, Double: () => _, Enum: () => X, Float: () => R, Hyper: () => P, Int: () => k, LargeInt: () => x, Opaque: () => M, Option: () => H, Quadruple: () => U, Reference: () => $, String: () => F, Struct: () => G, Union: () => Y, UnsignedHyper: () => C, UnsignedInt: () => I, VarArray: () => K, VarOpaque: () => V, Void: () => z, XdrReader: () => u, XdrWriter: () => f, config: () => ie });
            ...
            class d {
              ...
              fromXDR(e5, t5 = "raw") {
                ...
                const r5 = new u(b(e5, t5)), n3 = this.read(r5);
              ...
              static toXDR(e5, t5 = "raw") {
                const r5 = new f();
                return this.write(e5, r5), v(r5.finalize(), t5);
              }
            ...
            class m extends y {
              constructor(e5) {
                super(), this._maxDepth = e5 ?? m.DEFAULT_MAX_DEPTH;
              }
              static checkDepth(e5) {
                if (void 0 !== e5) {
                  if (!Number.isFinite(e5)) throw new TypeError(`remainingDepth (current remaining decoding depth budget) must be a finite number, got ${typeof e5}: ${e5}`);
                  if (e5 < 0) throw new o2("exceeded max decoding depth");
                }
              }
            }
            ...
            function w(e5, t5) {
              return null != e5 && (e5 instanceof t5 || S(e5, t5) && "function" == typeof e5.constructor.read && "function" == typeof e5.constructor.write && S(e5, "XdrType"));
            }
            function S(e5, t5) {
              do {
            ...
            class k extends h {
              ...
              static isValid(e5) {
                return "number" == typeof e5 && (0 | e5) === e5 && e5 >= -2147483648 && e5 <= E;
              }
            }
            function T(e5, t5) {
              return `${t5 ? "u" : "i"}${e5}`;
            ...
            function O(e5, t5) {
              const r5 = BigInt.asIntN(t5, e5) === e5, n3 = BigInt.asUintN(t5, e5) === e5;
              if (!r5 && !n3) throw new RangeError(`slice value ${e5} does not fit in ${t5} bits`);
            }
            ...
            class x extends h {
              constructor(e5) {
                super(), this._value = (function(e6, t5, r5) {
                  ...
                  if (1 === e6.length) {
                    const n4 = e6[0];
                    if (r5 && n4 < 0n) throw new RangeError(`expected a positive value, got: ${e6}`);
                    const [o4, i3] = A(t5, r5);
                    if (n4 < o4 || n4 > i3) throw new RangeError(`bigint value ${n4} for ${T(t5, r5)} out of range [${o4}, ${i3}]`);
                    return n4;
                  }
                  let o3 = 0n;
                  for (let t6 = 0; t6 < e6.length; t6++) O(e6[t6], n3), o3 |= BigInt.asUintN(n3, e6[t6]) << BigInt(t6 * n3);
                  r5 || (o3 = BigInt.asIntN(t5, o3));
                  const [i2, a2] = A(t5, r5);
                  if (o3 >= i2 && o3 <= a2) return o3;
                  throw new RangeError(`bigint values [${e6}] for ${T(t5, r5)} out of range [${i2}, ${a2}]: ${o3}`);
              ...
              slice(e5) {
                return (function(e6, t5, r5) {
                  ...
                  const n3 = t5 / r5;
                  if (1 === n3) return [e6];
                  if (r5 < 32 || r5 > 128 || 2 !== n3 && 4 !== n3 && 8 !== n3) throw new TypeError(`invalid bigint (${e6}) and slice size (${t5} -> ${r5}) combination`);
                  const o3 = BigInt(r5), i2 = new Array(n3);
                  for (let t6 = 0; t6 < n3; t6++) i2[t6] = BigInt.asIntN(r5, e6), e6 >>= o3;
                  return i2;
                })(this._value, this.size, e5);
              }
              toString() {
              ...
              static read(e5) {
                const { size: t5, unsigned: r5 } = this.prototype;
                return 64 === t5 ? new this(r5 ? e5.readBigUInt64BE() : e5.readBigInt64BE()) : new this(...Array.from({ length: t5 / 64 }, () => e5.readBigUInt64BE()).reverse());
              }
              static write(e5, t5) {
                ...
                if (64 === o3) r5 ? t5.writeBigUInt64BE(e5) : t5.writeBigInt64BE(e5);
                  ...
                  const n3 = r5 ? e5 : BigInt.asUintN(o3, e5);
                  for (let e6 = o3 / 64 - 1; e6 >= 0; e6--) t5.writeBigUInt64BE(n3 >> BigInt(64 * e6) & 0xffffffffffffffffn);
                }
              }
              static isValid(e5) {
                return e5 instanceof this || "bigint" == typeof e5 && e5 >= this.MIN_VALUE && e5 <= this.MAX_VALUE;
              }
            ...
            class I extends h {
              ...
              static write(e5, t5) {
                if ("number" != typeof e5 || !(e5 >= 0 && e5 <= B) || e5 % 1 != 0) throw new n2("invalid u32 value");
                t5.writeUInt32BE(e5);
              }
              static isValid(e5) {
                return "number" == typeof e5 && e5 % 1 == 0 && e5 >= 0 && e5 <= B;
              }
            }
            ...
            class F extends y {
              ...
              write(e5, t5) {
                const r5 = "string" == typeof e5 ? L.byteLength(e5, "utf8") : e5.length;
                if (r5 > this._maxLength) throw new n2(`got ${e5.length} bytes, max allowed is ${this._maxLength}`);
                I.write(r5, t5), t5.write(e5, r5);
              }
              isValid(e5) {
                return "string" == typeof e5 ? L.byteLength(e5, "utf8") <= this._maxLength : !!(e5 instanceof Array || L.isBuffer(e5)) && e5.length <= this._maxLength;
              }
            }
            var j = r4(686).hp;
            class M extends y {
              ...
              isValid(e5) {
                return j.isBuffer(e5) && e5.length === this._length;
              }
            }
            var D = r4(686).hp;
            class V extends y {
              ...
              isValid(e5) {
                return D.isBuffer(e5) && e5.length <= this._maxLength;
              }
            }
            class q extends m {
              constructor(e5, t5, r5 = m.DEFAULT_MAX_DEPTH) {
                super(r5), this._childType = e5, this._length = t5;
              }
              read(e5, t5 = this._maxDepth) {
                if (this._length > e5.remainingBytes()) throw new o2(`Array length ${this._length} exceeds remaining ${e5.remainingBytes()} bytes`);
                m.checkDepth(t5);
                const r5 = [];
                for (let n3 = 0; n3 < this._length; n3++) r5.push(this._childType.read(e5, t5 - 1));
                return r5;
              }
              write(e5, t5) {
            ...
            class K extends m {
              constructor(e5, t5 = I.MAX_VALUE, r5 = m.DEFAULT_MAX_DEPTH) {
                super(r5), this._childType = e5, this._maxLength = t5;
              }
              read(e5, t5 = this._maxDepth) {
                m.checkDepth(t5);
                const r5 = I.read(e5);
                if (r5 > this._maxLength) throw new o2(`saw ${r5} length VarArray, max allowed is ${this._maxLength}`);
                if (r5 > e5.remainingBytes()) throw new o2(`VarArray length ${r5} exceeds remaining ${e5.remainingBytes()} bytes`);
                const n3 = [];
                for (let o3 = 0; o3 < r5; o3++) n3.push(this._childType.read(e5, t5 - 1));
                return n3;
              }
              write(e5, t5) {
            ...
            class H extends m {
              constructor(e5, t5 = m.DEFAULT_MAX_DEPTH) {
                super(t5), this._childType = e5;
              }
              read(e5, t5 = this._maxDepth) {
                if (m.checkDepth(t5), N.read(e5)) return this._childType.read(e5, t5 - 1);
              }
              write(e5, t5) {
                const r5 = null != e5;
                N.write(r5, t5), r5 && this._childType.write(e5, t5);
              }
              isValid(e5) {
            ...
            class X extends h {
              ...
              static isValid(e5) {
                return e5?.constructor?.enumName === this.enumName || w(e5, this);
              }
              static members() {
            ...
            class G extends m {
              constructor(e5, t5) {
                super(t5 ?? new.target?._maxDepth), this._attributes = e5 || {};
              }
              static read(e5, t5 = this._maxDepth) {
                m.checkDepth(t5);
                const r5 = {};
                for (const [n3, o3] of this._fields) r5[n3] = o3.read(e5, t5 - 1);
                return new this(r5, this._maxDepth);
              }
              static write(e5, t5) {
              ...
              static isValid(e5) {
                return e5?.constructor?.structName === this.structName || w(e5, this);
              }
              static create(e5, t5, r5, n3 = m.DEFAULT_MAX_DEPTH) {
                const o3 = class extends G {
                };
                o3.structName = t5, o3._maxDepth = n3, e5.results[t5] = o3;
                const i2 = new Array(r5.length);
                for (let t6 = 0; t6 < r5.length; t6++) {
                  const n4 = r5[t6], a2 = n4[0];
                  let s2 = n4[1];
                  s2 instanceof $ && (s2 = s2.resolve(e5)), i2[t6] = [a2, s2], o3.prototype[a2] = W(a2);
                }
                return o3._fields = i2, o3;
              }
            }
            function W(e5) {
              return function(t5) {
            ...
            class Y extends m {
              constructor(e5, t5, r5) {
                super(r5 ?? new.target?._maxDepth), this.set(e5, t5);
              }
              set(e5, t5) {
                ...
                this._arm = r5, this._armType = r5 === z ? z : this.constructor._arms[r5], this._value = t5;
              }
              get(e5 = this._arm) {
                if (this._arm !== z && this._arm !== e5) throw new TypeError(`${e5} not set`);
                return this._value;
              }
              switch() {
                return this._switch;
              ...
              static armTypeForArm(e5) {
                return e5 === z ? z : this._arms[e5];
              }
              static read(e5, t5 = this._maxDepth) {
                m.checkDepth(t5);
                const r5 = this._switchOn.read(e5, t5 - 1), n3 = this.armForSwitch(r5), o3 = n3 === z ? z : this._arms[n3];
                let i2;
                return i2 = void 0 !== o3 ? o3.read(e5, t5 - 1) : n3.read(e5, t5 - 1), new this(r5, i2, this._maxDepth);
              }
              static write(e5, t5) {
              ...
              static isValid(e5) {
                return e5?.constructor?.unionName === this.unionName || w(e5, this);
              }
              static create(e5, t5, r5, n3 = m.DEFAULT_MAX_DEPTH) {
                const o3 = class extends Y {
                };
                o3.unionName = t5, o3._maxDepth = n3, e5.results[t5] = o3, r5.switchOn instanceof $ ? o3._switchOn = r5.switchOn.resolve(e5) : o3._switchOn = r5.switchOn, o3._switches = /* @__PURE__ */ new Map(), o3._arms = {};
                let i2 = r5.defaultArm;
                i2 instanceof $ && (i2 = i2.resolve(e5)), o3._defaultArm = i2;
                for (const [e6, t6] of r5.switches) {
                  const r6 = "string" == typeof e6 ? o3._switchOn.fromName(e6) : e6;
                  o3._switches.set(r6, t6);
                }
                if (void 0 !== o3._switchOn.values) for (const e6 of o3._switchOn.values()) o3[e6.name] = function(t6) {
                  return new o3(e6, t6);
                }, o3.prototype[e6.name] = function(t6) {
                  return this.set(e6, t6);
                };
                if (r5.arms) for (const [t6, n4] of Object.entries(r5.arms)) o3._arms[t6] = n4 instanceof $ ? n4.resolve(e5) : n4, n4 !== z && (o3.prototype[t6] = function() {
                  return this.get(t6);
                });
                return o3;
              }
            ...
            class J extends $ {
              ...
              resolve(e5) {
                ...
                return t5 instanceof $ && (t5 = t5.resolve(e5)), r5 instanceof $ && (r5 = r5.resolve(e5)), this.variable ? new K(t5, r5) : new q(t5, r5);
              }
            }
            class Q extends $ {
              constructor(e5) {
              ...
              resolve(e5) {
                ...
                return t5 instanceof $ && (t5 = t5.resolve(e5)), new H(t5);
              }
            }
            class ee extends $ {
              constructor(e5, t5) {
              ...
              resolve(e5) {
                let t5 = this.length;
                return t5 instanceof $ && (t5 = t5.resolve(e5)), new this.sizedType(t5);
              }
            }
            class te {
              constructor(e5, t5, r5) {
            ...
            function re(e5, t5, r5) {
              return r5 instanceof $ && (r5 = r5.resolve(e5)), e5.results[t5] = r5, r5;
            }
            function ne(e5, t5, r5) {
            ...
            class oe {
              ...
              enum(e5, t5) {
                const r5 = new te(X.create, e5, t5);
                this.define(e5, r5);
              }
              struct(e5, t5) {
                const r5 = new te(G.create, e5, t5);
                this.define(e5, r5);
              }
              union(e5, t5) {
                const r5 = new te(Y.create, e5, t5);
                this.define(e5, r5);
              }
              typedef(e5, t5) {
                const r5 = new te(re, e5, t5);
                this.define(e5, r5);
              }
              const(e5, t5) {
                const r5 = new te(ne, e5, t5);
                this.define(e5, r5);
              }
              void() {
                return z;
        ...
        function x(e3, t3, r3) {
          ...
          if (0 === v2) {
            var A2 = c2.split("\n");
            if (A2.length > 30) for (A2[26] = "".concat(w, "...").concat(k); A2.length > 27; ) A2.pop();
        ...
        var P = (function(e3, t3) {
          ...
          function b2(e4) {
            ...
            if (Error.stackTraceLimit = 0, null != r4) t4 = p2.call(this, String(r4));
              ...
              if ("notStrictEqual" === o3 && "object" === m(a3) && null !== a3 && (f3 = T.notStrictEqualObject), d2.length > 30) for (d2[26] = "".concat(w, "...").concat(k); d2.length > 27; ) d2.pop();
        ...
        e2.exports = function() {
          return "function" == typeof n && ("function" == typeof Symbol && ("symbol" == typeof n("foo") && ("symbol" == typeof /* @__PURE__ */ Symbol("bar") && o())));
        };
      }, 4107(e2, t2, r2) {
        "use strict";
        ...
        var c, l, f = r2(9597).codes, p = f.ERR_AMBIGUOUS_ARGUMENT, d = f.ERR_INVALID_ARG_TYPE, h = f.ERR_INVALID_ARG_VALUE, y = f.ERR_INVALID_RETURN_VALUE, m = f.ERR_MISSING_ARGS, g = r2(3918), v = r2(537).inspect, b = r2(537).types, w = b.isPromise, S = b.isRegExp, E = r2(9133)(), k = r2(9394)(), T = r2(8075)("RegExp.prototype.test");
        /* @__PURE__ */ new Map();
        function A() {
          var e3 = r2(2299);
        ...
        "use strict";
        var n = r2(6763);
        const o = r2(7526), i = r2(251), a = "function" == typeof Symbol && "function" == typeof Symbol.for ? /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom") : null;
        ...
        "use strict";
        var n = r2(1189), o = "function" == typeof Symbol && "symbol" == typeof /* @__PURE__ */ Symbol("foo"), i = Object.prototype.toString, a = Array.prototype.concat, s = r2(41), u = r2(592)(), c = function(e3, t3, r3, n2) {
          if (t3 in e3) {
            if (true === n2) {
              if (e3[t3] === r3) return;
        ...
        t2.isArgumentsObject = n, t2.isGeneratorFunction = o, t2.isTypedArray = a, t2.isPromise = function(e3) {
          ...
          return w(e3);
        }, S.working = "undefined" != typeof ArrayBuffer && S(new ArrayBuffer()), t2.isArrayBuffer = E, k.working = "undefined" != typeof ArrayBuffer && "undefined" != typeof DataView && k(new DataView(new ArrayBuffer(1), 0, 1)), t2.isDataView = T;
...
// scripts/stellar-entry.js
var stellar_entry_exports = {};
module.exports = __toCommonJS(stellar_entry_exports);
__reExport(stellar_entry_exports, __toESM(require_stellar_base_min()), module.exports);
