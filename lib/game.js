...
class Runa {
  ...
  view() {
    ...
    if (this.field) {
      ...
      return render.compose({
        ...
        footer: snap.combat
          ...
          : snap.boss && snap.boss.active && !snap.boss.defeated
            ? autosave + 'wasd esquivar poderes | f atacar jefe | t volver a la ciudad'
    ...
    const nearbyOnline = duel || nearby ? null : this.nearbyPlayer(2)
    ...
    return render.mapScreen({
      ...
      footer: duel
        ...
        : this.duelInvite && this.duelInvite.direction === 'in'
          ...
          : autosave + 'wasd o flechas | e hablar / desafiar | v wallet | q salir',
      map: {
