...
class Runa {
  ...
  onKey(msg) {
    ...
    if (key.matches(msg, 'f') && this.field) {
      ...
      else this.say('el Coloso esta al otro lado del portal O, en el nordeste')
      return null
    }
  ...
  view() {
    ...
    if (this.walletOpen) {
      return render.compose({
        ...
        footer: this.walletEditing
          ? 'enter vincular | esc cancelar | solo direccion publica G...'
          : 'enter / a vincular | x desvincular | v / esc volver'
      })
    }
    ...
    if (this.rankingOpen) {
      return render.rankingScreen({
        ...
        footer: 'izquierda/derecha o tab cambiar ranking | e / esc volver'
      })
    }
    ...
    if (this.inventoryOpen) {
      ...
      return render.inventoryScreen({
        ...
        footer: this.inventoryHome
          ? autosave +
            'izq/der cambiar mochila/deposito | enter transferir | x equipar/quitar | esc salir'
          : autosave + 'arriba/abajo elegir | enter equipar | x equipar/quitar | i / esc salir'
      })
    }
          ...
          : snap.mode === 'dungeon'
            ...
            : snap.mode === 'boss'
              ...
              : snap.boss && snap.boss.active && !snap.boss.defeated
                ...
                : autosave + 'wasd mover | X cripta SE | O portal NE | t volver a la ciudad'
      })
    }
    ...
    return render.mapScreen({
      ...
      cellW: 1,
      footer: duel
        ? autosave + 'wasd mover | f / espacio atacar | r rendirse | q salir del juego'
        : this.duelInvite && this.duelInvite.direction === 'in'
          ? autosave + 'enter aceptar duelo | n rechazar | q salir'
          : autosave + 'wasd o flechas | e hablar | i inventario | v wallet | q salir',
      map: {
