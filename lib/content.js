...
const foes = {
  ...
  barbarian_raider: {
    id: 'barbarian_raider',
    name: 'saqueador barbaro',
    flying: false,
    glyph: 'b',
    stats: { hp: 24, atk: 6, reach: 3, speed: 0.2, cooldown: 21 },
    zone: 'barbarian-camp',
    drop: { gold: [8, 13], xp: 12 },
    about: 'un guerrero de frontera armado con hacha y cuero endurecido'
  },

  barbarian_thrower: {
    id: 'barbarian_thrower',
    name: 'lanzador barbaro',
    flying: false,
    glyph: 'r',
    stats: { hp: 20, atk: 6, reach: 12, speed: 0.17, cooldown: 25 },
    zone: 'barbarian-camp',
    drop: { gold: [9, 15], xp: 14 },
    about: 'hostiga desde detras de las empalizadas con jabalinas pesadas'
  },

  barbarian_chief: {
    id: 'barbarian_chief',
    name: 'caudillo barbaro',
    flying: false,
    glyph: 'B',
    stats: { hp: 46, atk: 9, reach: 5, speed: 0.15, cooldown: 24 },
    zone: 'barbarian-camp',
    drop: { gold: [20, 30], xp: 32 },
    about: 'el jefe del asentamiento, cubierto de trofeos y placas robadas'
  },
