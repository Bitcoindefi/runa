...
/**
 * Carved runes are straight strokes and diagonals only, because a curve
 * cannot be cut into stone. The wordmark keeps that rule.
 */
const LOGO = [
  '  ___   _   _  _  _     _   ',
  ' | _ \\ | | | || \\| |   /_\\  ',
...
function titleScreen(w, h) {
  const art = LOGO[0].length + 2 <= w ? LOGO : ['r u n a']
